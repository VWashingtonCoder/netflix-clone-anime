...
async function main() {
  ...
  const movie1 = await prisma.movie.upsert({
    ...
    create: {
      title: "Liar Liar",
      description:
        "Hiroto Shinohara, a new transfer student to Academy Island, inadvertently challenges Sarasa Saionji, the island's revered Empress, on his first day. He wins a crucial game through a bluff, but must now maintain a facade of being a high-ranking Seven Star student to avoid expulsion. Assisted by the secretive Company led by Shirayuki Himeji, Hiroto navigates challenges from jealous peers while searching for a missing girl from his past, all while hiding his true One Star status.",
      videoUrl:
        "https://www.dropbox.com/scl/fi/xwew9ntgwjmlp3u4rzsvn/liar-liar-season-1-episode-1_HD.mp4?rlkey=3e3xfh0lq2dne9kgr0jm5zq9h&st=lwihsjre&raw=1",
  ...
  const movie2 = await prisma.movie.upsert({
    ...
    create: {
      ...
      description:
        "Al Wayne, striving to excel as a farmer, achieves top-tier cultivation skills and becomes a first-rate cultivator. His newfound prowess surpasses even legendary heroes, prompting the royal family to seek his aid against mounting disasters. Reluctant yet determined to protect his fields, Al accepts the responsibility of defending against these threats.",
      videoUrl:
        "https://www.dropbox.com/scl/fi/kv0nbqiuq8c1kfxvc68p1/I-ve-Somehow-Gotten-Stronger-When-I-Improved-My-Farm-Related-Skills-Episode-_Full-HD.mp4?rlkey=ooydfeapconqa8y0o8rkpv8hs&st=41069124&raw=1",
  ...
  const movie4 = await prisma.movie.upsert({
    ...
    create: {
      ...
      videoUrl:
        "https://www.dropbox.com/scl/fi/5qubfbtzuiil4wnd22zko/To-Your-Eternity-Ep.-1-_-DUB-_-The-Last-One_HD.mp4?rlkey=gb8v9zuyeowt7t1sx41dpw8s1&st=ruo1h9al&raw=1",
